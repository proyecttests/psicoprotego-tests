...
/**
 * @file app/[lang]/test/[testId]/start/page.tsx
 * @description Intersticial clínico entre la landing y el test.
 *
 * Client Component: carga el disclaimer del JSON vía fetch en cliente,
 * y navega con useRouter de next/navigation.
 *
 * No es contenido indexable — usa noindex vía el wrapper en layout o
 * mediante robots.txt. Esta ruta es transicional.
 */
...
// ── Helper: renderiza **negrita** inline ──────────────────────────────────────
    ...
    <div className="flex flex-col" style={{ backgroundColor: 'var(--color-cream)' }}>
      <main className="flex flex-1 flex-col items-center px-4 py-10 sm:px-6">
        <div className="w-full max-w-xl mx-auto flex flex-col gap-8">
          ...
          {/* ── 1. DISCLAIMER ────────────────────────────────────────────── */}
          <section aria-labelledby="interstitial-title" aria-describedby="interstitial-body">
            <div
              className="rounded-xl p-6 shadow-sm"
              style={{ backgroundColor: '#fff', border: '1px solid rgba(45,74,62,0.15)' }}
            >
